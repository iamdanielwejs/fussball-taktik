...
- [x] Define CI scripts in package.json
...
- [x] Implement normalized coordinate system (0-100 → pixels)
- [ ] Responsive scaling
- [x] Unit tests for coordinate transformation
